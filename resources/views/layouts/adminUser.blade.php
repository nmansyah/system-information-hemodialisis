        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/admin/dashboard" class="site_title"> <img src="{{ asset('images/logo-pku.png') }}" alt="" style="width:30px; height:30px"> <span>HEMODIALISIS</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="/admin/dashboard"><i class="fa fa-dashboard"></i>
                      Halaman Utama 
                    </a>
                  </li>
                  ...
                  <li><a><i class="fa fa-users"></i>
                    ...
                    <ul class="nav child_menu">                                            
                      <li><a href="/admin/dataDokter">Dokter</a></li>
                      <li><a href="/admin/dataPasien">Pasien</a></li>
                      <li><a href="/admin/dataPerawat">Perawat</a></li>                      
                    </ul>
                  </li>
                  ...
                  <li><a href="/admin/dataKehadiranPasien"><i class="fa fa-calendar-o"></i>
                        Kehadiran Pasien
                      </a>
                  </li>
                  ...
                  <li><a href="/admin/dataPasienMeninggal"><i class="fa fa-user"></i>

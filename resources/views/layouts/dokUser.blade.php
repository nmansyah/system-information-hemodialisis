        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/dok/halamanUtama" class="site_title"> <img src="{{ asset('images/logo-pku.png') }}" alt="" style="width:30px; height:30px"> <span>HEMODIALISIS</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="/dok/halamanUtama"><i class="fa fa-dashboard"></i>
                      Halaman Utama 
                    </a>
                  </li>
                  ...
                  <li><a href="/dok/dataPerkembanganPasien"><i class="fa fa-edit"></i> 
                        Kondisi Pasien Bulanan
                      </a>
                  </li>
                  
                  <li><a href="/dok/dataPasienMeninggal"><i class="fa fa-user"></i>
                        Data Pasien Meninggal
                      </a>
                  </li>

                  <li><a href="/dok/dataPasienTraveling"><i class="fa fa-user"></i>
                        Data Pasien Traveling
                      </a>
                  </li>

                  <li><a href="/dok/dataPasienRawatinap"><i class="fa fa-user"></i>

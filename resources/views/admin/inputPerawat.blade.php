...
@section('title', 'Input Perawat')

@section('content')
    <div class="x_content">

        <form class="form-horizontal form-label-left" action="/admin/inputPerawat" method="post" value="post" novalidate>
        <span class="section">Masukkan Data Perawat</span>
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <input id="pendidikan" class="form-control col-md-7 col-xs-12" name="pendidikan" required="required" type="text">
            </div>
        </div>
        <div class="item form-group">

    ...
    <div class="x_content">
        ...
        <span class="section">Masukkan Data Pasien</span>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="number" id="usia" name="usia" required="required" data-validate-minmax="1,100" class="form-control col-md-7 col-xs-12">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="riwayat" class="form-control col-md-7 col-xs-12" name="riwayat" required="required" type="text">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="asuransi" class="form-control col-md-7 col-xs-12" name="asuransi" required="required" type="text">
                </div>
            </div>
            <div class="item form-group">

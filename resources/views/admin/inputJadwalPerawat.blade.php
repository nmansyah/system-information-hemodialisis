...
@section('title', 'Input Jadwal Perawat')
...
<div class="x_content">
        ...
        <form class="form-horizontal form-label-left" action="/admin/inputJadwalPerawat" method="post" value="post" novalidate>
        <span class="section">Masukkan Jadwal Perawat</span>

        <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bulan">Bulan <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="bulan" type="date" name="bulan" class="optional form-control col-md-7 col-xs-12">
                </div>
        </div>
        ...
        <div class="item form-group">
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary" onclick="location.href='/admin/jadwalPerawat'">Cancel</button>

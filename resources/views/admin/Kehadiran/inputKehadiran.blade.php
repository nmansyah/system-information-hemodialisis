...
@section('content')
        ...
        <form class="form-horizontal form-label-left" action="/admin/{{ $pasien->id }}/inputKehadiran" method="post" value="post" novalidate>
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary" onclick="location.href='/admin/{{ $pasien->id }}/dataKehadiran'">Cancel</button>

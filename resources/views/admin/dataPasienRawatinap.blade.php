...
@section('content') 
      <a href="/admin/inputPasienRawatinap"><button type="button" class="btn btn-primary">Tambah Data</button></a>
                      ...
                      @foreach ($pasien_rawatinap as $pr)
                        <tr>
                            ...
                            <div class="tombolAksi" >
                                  <a href="/admin/inputPasienRawatinap/{{ $pr->id }}/edit" onclick="return confirm ('Apakah Anda Ingin Merubah Data Ini?')" class="btn btn-sm" style="height: 5; weight: 5"><i class="fa fa-edit"></i></a>
                                </div>
                            </td>
                            <td>
                              <div class="aksi">
                                ...
                                <div class="tombolAksi">
                                    <form method="post" action="{{ route('admin.pasienRawatinap.delete',['id' => $pr->id]) }}">
                                       {{ method_field('DELETE') }}

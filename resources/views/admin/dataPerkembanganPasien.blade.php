...
@section('content')
    ...
    <a href="/admin/inputPerkembanganPasien">
                ...
                <table class="table table-bordered" id="datatable-buttons">
                    ...
                    @foreach ($perkembangan_pasien as $pp)
                        <tr>
                            ...
                            <td>{{ $pp->obat}}</td>
                            <td>
                                <a href="{{ route('admin.data.perkembangan.pasien.show', $pp->pasien_id) }}"><i
                                        class="fa fa-eye"></i></a>
                            </td>
                            <td>
                                <div class="tombolAksi">
                                    <a href="/admin/inputPerkembanganPasien/{{ $pp->id }}/edit"
                            ...
                            <td>
                                <div class="Aksi">
                                    <div class="tombolAksi">
                                        <form method="post"
                                              action="{{ route('admin.perkembanganPasien.delete',['id' => $pp->id]) }}">
                                            {{ method_field('DELETE') }}

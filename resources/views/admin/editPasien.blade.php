...
@section('content')
    ...
    <div class="x_content">
        ...
        <form class="form-horizontal form-label-left" action="/admin/inputPasien/{{$pasien->id}}/update" method="post"
              value="post" novalidate>
            {{ csrf_field() }}
            @method('PUT')
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="number" id="no_cm" name="no_cm" required="required"
                           class="form-control col-md-7 col-xs-12" value="{{ $pasien->no_cm }}">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="nama" class="form-control col-md-7 col-xs-12" data-validate-length-range="4"
                           data-validate-words="1" name="nama" required="required" value="{{ $pasien->nama }}"
                           type="text">
                </div>
            </div>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="number" id="no_hp" name="no_hp" required="required"
                           class="form-control col-md-7 col-xs-12" value="{{ $pasien->no_hp }}">
                </div>
            </div>
            <div class="item form-group">
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="riwayat" class="form-control col-md-7 col-xs-12" name="riwayat" required="required"
                           value="{{ $pasien->riwayat }}" type="text">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="asuransi" class="form-control col-md-7 col-xs-12" name="asuransi" required="required"
                           value="{{ $pasien->asuransi }}" type="text">
                </div>
            </div>
            <div class="item form-group">
            ...
            <div class="item form-group">
                ...
                <div class="col-8 col-md-2">
                    <select class="custom-select" id="hari3" name="hari3">
                        <option selected>{{ $pasien->hari3 }}</option>
                        <option value="Senin">Senin</option>
                        <option value="Selasa">Selasa</option>
                        <option value="Rabu">Rabu</option>
                        <option value="Kamis">Kamis</option>
                ...
                <div class="col-8 col-md-4">
                    <select class="custom-select" id="sesi3" name="sesi3">
                        <option selected>{{ $pasien->sesi3 }}</option>
                        <option value="Sesi 1">Sesi 1</option>
                        <option value="Sesi 2">Sesi 2</option>
                        <option value="Sesi 3">Sesi 3</option>
                    </select>

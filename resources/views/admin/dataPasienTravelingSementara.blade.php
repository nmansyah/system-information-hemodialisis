...
@section('content')
    <a href="/admin/inputPasienTravelingSementara">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="tombolAksi">
                                    <a href="/admin/inputPasienTravelingSementara/{{ $pts->id }}/edit"
                            ...
                            <td>
                                ...
                                <div class="tombolAksi">
                                    <form method="post"
                                          action="{{ route('admin.pasienTravelingSementara.delete',['id' => $pts->id]) }}">
                                        {{ method_field('DELETE') }}

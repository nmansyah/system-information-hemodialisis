  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      // $('.js-example-basic-multiple').select2();
        ...
        <form class="form-horizontal form-label-left" action="/pegawai/inputPasienTravelingSementara/{{$pasien_traveling_sementara->id}}/update" method="post" value="post" novalidate>
        {{ csrf_field() }}
            @method('PUT')
        <span class="section">Edit Data Pasien Traveling Sementara</span>
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary" onclick="location.href='/pegawai/dataPasienTravelingSementara'">Cancel</button>

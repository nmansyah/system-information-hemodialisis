...
@section('content')
    <a href="/pegawai/inputPasienRawatinap">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="aksi">
                                    ...
                                    <div class="tombolAksi">
                                        <form method="post"
                                              action="{{ route('pegawai.pasienRawatinap.delete',['id' => $pr->id]) }}">
                                            {{ method_field('DELETE') }}

...
@section('content')
    ...
    <form class="form-horizontal form-label-left" action="/pegawai/inputPerpindahanJadwal/{{$perpindahan_jadwal->id}}/update" method="post" value="post" novalidate>
            {{ csrf_field() }}
            @method('PUT')
        <span class="section">Edit Perpindahan Jadwal Sementara</span>
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary" onclick="location.href='/pegawai/dataPerpindahJadwal'">Cancel</button>

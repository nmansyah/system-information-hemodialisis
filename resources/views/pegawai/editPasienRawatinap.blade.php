  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      // $('.js-example-basic-multiple').select2();
        ...
        <form class="form-horizontal form-label-left" action="/pegawai/inputPasienRawatinap/{{$pasien_rawatinap->id}}/update" method="post" value="post" novalidate>
        {{ csrf_field() }}
            @method('PUT')
        <span class="section">Edit Data Pasien Rawat Inap</span>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="unit" type="text" name="unit" class="optional form-control col-md-7 col-xs-12" value="{{ $pasien_rawatinap->unit }}">
                </div>
            </div>
            <div class="ln_solid"></div>
            <div class="form-group">
                <div class="col-md-6 col-md-offset-4">
                <button type="submit" class="btn btn-primary" onclick="location.href='/pegawai/dataPasienRawatinap'">Cancel</button>

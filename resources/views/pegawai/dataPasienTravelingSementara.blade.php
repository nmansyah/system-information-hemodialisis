...
@section('content')
    <a href="/pegawai/inputPasienTravelingSementara">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="tombolAksi">
                                    <a href="/pegawai/inputPasienTravelingSementara/{{ $pts->id }}/edit"
                                       onclick="return confirm ('Apakah Anda Ingin Merubah Data Ini?')"
                                       class="btn btn-sm" style="height: 10; weight: 10"><i class="fa fa-edit"></i></a>
                                </div>
                            </td>
                            <td>
                                <div class="tombolAksi">
                                    <form method="post"
                                          action="{{ route('pegawai.pasienTravelingSementara.delete',['id' => $pts->id]) }}">
                                        {{ method_field('DELETE') }}

...
@section('content')
    ...
    <div class="x_content">
        ...
        <form class="form-horizontal form-label-left" action="/pegawai/inputPasienRawatinap" method="post" value="post"
              novalidate>
            ...
            <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tanggal">Tanggal Masuk <span
                        class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
                <div class="col-md-6 col-md-offset-4">
                    <button type="submit" class="btn btn-primary"
                            onclick="location.href='/pegawai/dataPasienRawatinap'">Cancel
                    </button>

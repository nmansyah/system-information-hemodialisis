...
<a href="/pegawai/inputPerkembanganPasien"><button type="button" class="btn btn-primary">Tambah Data</button></a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="tombolAksi" >
                                  <a href="/pegawai/inputPerkembanganPasien/{{ $pp->id }}/edit" onclick="return confirm ('Apakah Anda Ingin Merubah Data Ini?')" class="btn btn-sm"><i class="fa fa-edit"></i></a>
                                </div>
                            </td>
                            <td>
                              <div class="Aksi">
                                ...
                                <div class="tombolAksi">
                                    <form method="post" action="{{ route('pegawai.perkembanganPasien.delete',['id' => $pp->id]) }}">
                                       {{ method_field('DELETE') }}
